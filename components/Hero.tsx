    ...
    <>
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        ...
        <p className="text-base sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light">
          Gemini 3 Pro sees the code in everything. Drop in an old map, a floor plan, a diagram, or a doodle, and watch it turn into a working interactive experience instantly.
        </p>
      </div>
    </>
  );
